class Admin::CoursesController < ApplicationController
  ...
  private
    ...
    def course_params
      params.expect(course: [ :course_number, :title, :instructor_id, :year, :semester, :start_date, :end_date, :start_time, :end_time, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday ])
    end
  def require_admin
